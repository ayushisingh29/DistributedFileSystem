...
public class NamingServer implements Service, Registration
{
            ...
            throws RMIException, FileNotFoundException
    {
        ...
        return this.pathStorageStubMap.get(file).create(file);
...
//        return false;
                           ...
                           Path[] files)
    {
        ...
        for(Path p: files) {
            try {
                ...
                if(this.pathStorageStubMap.containsKey(p)) {
                    ...
                    System.out.println(this.pathStorageStubMap);
        ...
        System.out.println(this.getClass().getName() + ":Delete paths " + this.deleteFiles);
